...
import { ModalEditEmpresas } from "./components/ModalEditEmpresas";
import { ModalDeleteEmpresas } from "./components/ModalDeleteEmpresas";
import {
    ...
    if (
      ...
      if (addMode) {
        ...
        axios
          ...
          .then(({ data }) => {
            console.log(data);
            CallToast(messagePositivo("Organización"), "primary");
            actualizar();
            setShow(false);
            setWaitAxios(false);
          })
      ...
      {loading ? (
        ...
        <>
          <div className="container-fluid mt-2 text-secondary">
            <h3>
              <i className="bi bi-globe2"></i> Empresas y Organizaciones
            </h3>
            <hr />

            <Button variant="secondary" onClick={handleShow}>
              <i className="bi bi-plus-circle"></i> Agregar Organización
            </Button>
            ...
            {filteredOrganizations.length ? (
              <TablaEmpresas
                empresas={filteredOrganizations}
