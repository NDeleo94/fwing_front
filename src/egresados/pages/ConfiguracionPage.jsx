...
import { AdminEmpresas } from "../../admin/components/AdminEmpresas/AdminEmpresas";
import { SeguridadEgresados } from "../components/SeguridadEgresados";
import { AdminPuestos } from "../../admin/components/AdminPuestos/AdminPuestos";
import { AdminCiudades } from "../../admin/components/AdminCiudades/AdminCiudades";
...
export const ConfiguracionPage = () => {
  ...
  return loading ? (
    ...
    <>
      <Row className="my-3">
        <h1>
          <i className="bi bi-house-gear"></i> Configuración
        </h1>
      </Row>
      <hr />
      <Tab.Container
            ...
            <Col sm={3} className="bg-light py-2">
              ...
              {user.is_admin ? (
                <>
                  Administración
                  <ListGroup>
                    <ListGroup.Item action href="#filtrarEgresados">
                      Superfiltro
                    </ListGroup.Item>
                    <ListGroup.Item action href="#agregarEgresado">
                      Agregar Egresado
                    </ListGroup.Item>
                    <ListGroup.Item action href="#modificarEgresado">
                      Administrar Egresado
                    </ListGroup.Item>
                    <ListGroup.Item action href="#administrarEmpresas">
                      Administrar Empresas
                    </ListGroup.Item>
                    <ListGroup.Item action href="#administrarPuestos">
                      Administrar Puestos
                    </ListGroup.Item>
                    <ListGroup.Item action href="#administrarCiudades">
                      Administrar Ciudades
                    </ListGroup.Item>
                    <ListGroup.Item action href="#administradores">
                      Administradores
                    </ListGroup.Item>
                    <ListGroup.Item action href="#enviarEmails">
                      Enviar e-mails
                    </ListGroup.Item>
                  </ListGroup>
                </>
