...
export const ConfiguracionEgresos = ({ egresado }) => {
  ...
  const [isLoadingSelectFacultad, setIsLoadingSelectFacultad] = useState(false);
  ...
  return (
    <>
      <div className="container-fluid mt-2 text-secondary">
        ...
        {datoEgresado?.egresos.length ? (
          <TablaEgresos
            egresos={datoEgresado.egresos}
            handleEdit={handleEdit}
            handleDelete={handleDelete}
          />
        ) : (
          <div>"No hay titulos"</div>
        )}

        <div className="my-2" style={{ fontSize: "10pt" }}>
          * : Es el título a cuál se le realiza seguimiento. Si desea
          modificarlo, contáctese con egresados.computacion@herrera.unt.edu.ar
        </div>
        ...
        <Modal show={show} onHide={handleClose}>
          <Modal.Header closeButton>
            <Modal.Title>{addMode ? "Agregar" : "Editar"} Egreso</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form>
              <div className="row">
              ...
              <Form.Group className="mb-3" controlId="formUniversidad">
                ...
                <CreatableSelect
                  ...
                  onChange={(newValue) => setValueUniversidad(newValue)}
                  onCreateOption={handleCreateSelectUniversidad}
              ...
              <Form.Group className="mb-3" controlId="formFacultad">
                ...
                <CreatableSelect
                  isClearable
                  isDisabled={isLoadingSelectFacultad || !valueUniversidad}
                  isLoading={isLoadingSelectFacultad}
                  onChange={(newValue) => setValueFacultad(newValue)}
              ...
              <Form.Group className="mb-3" controlId="formCarrera">
                ...
                <CreatableSelect
                  ...
                  onChange={(newValue) => {
                    ...
                    if (newValue?.label == "Ingeniería en Computación") {
              ...
              <Form.Group className="mb-3" controlId="formpostgrado">
                <Form.Check
                  type="switch"
                  id="custom-switch"
                  label="¿Es postgrado?"
                ...
                >
                  {(!formState.ciclo_egreso ||
                    ...
                    <>
                      ...
                      {!formState.ciclo_egreso ? "Año de Egreso," : ""}
